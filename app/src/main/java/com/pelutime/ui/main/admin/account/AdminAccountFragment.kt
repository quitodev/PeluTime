package com.pelutime.ui.main.admin.account
...
import com.pelutime.databinding.FragmentAdminAccountBinding
import com.pelutime.presentation.main.admin.account.AdminAccountViewModel
...
class AdminAccountFragment : Fragment() {
    ...
    // VIEW MODEL
    private val viewModel by viewModels<AdminAccountViewModel>()
    ...
    private fun setEventsButtons(image: String) {
        ...
        binding.textHelp.setOnClickListener {
            Toast.makeText(context, "Cualquier duda o inconveniente, por favor envíenos un mail a soportepelutime@gmail.com y le responderemos a " +
                    "la brevedad!", Toast.LENGTH_LONG).show()
        }
    }
