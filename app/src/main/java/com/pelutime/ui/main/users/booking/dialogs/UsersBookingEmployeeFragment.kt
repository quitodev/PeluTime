...
import com.pelutime.databinding.FragmentUsersBookingEmployeeDialogBinding

class UsersBookingEmployeeFragment : DialogFragment() {

    // VIEW BINDING
    private var _binding: FragmentUsersBookingEmployeeDialogBinding? = null
    private val binding get() = _binding!!

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        dialog?.window?.requestFeature(Window.FEATURE_NO_TITLE)
        _binding = FragmentUsersBookingEmployeeDialogBinding.inflate(inflater, container, false)
        return binding.root
    }
